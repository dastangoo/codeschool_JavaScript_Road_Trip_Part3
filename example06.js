...
Object.prototype.findOwenerOfProperty = function (propName) {
...
console.log(twister.findOwenerOfProperty("valueOf"));
console.log(twister.findOwenerOfProperty("toString"));
console.log(twister.findOwenerOfProperty("goToOz"));